...
![image-20210311220529009](assets/image-20210311220529009.png)
...
![image-20210311220606973](assets/image-20210311220606973.png)
...
#### 1.2 ECMAScript 和JavaScript的关系

<span style="color:red">一个常见的问题是，ECMAScript 和 JavaScript 到底是什么关系？</span>
...
<span style="color:red">这就是声明式渲染</span>：Vue.js 的核心是一个允许采用简洁的模板语法来声明式地将数据渲染进 DOM 的系统
...
![image-20210311221817285](assets/image-20210311221817285.png)
...
![image-20210311222323648](assets/image-20210311222323648.png)
...
![image-20210311222337138](assets/image-20210311222337138.png)
