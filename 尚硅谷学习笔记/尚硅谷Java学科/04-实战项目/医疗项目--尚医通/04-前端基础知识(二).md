...
![image-20210311235753568](assets/image-20210311235753568.png)
...
<span style="color:red">ES6使用 export 和 import 来导出、导入模块。</span>
...
```shell
nodeteacherComponent.js
```

<span style="color:red">注意：这时的程序无法运行的，因为ES6的模块化无法在Node.js中执行，需要用Babel编辑成ES5后再执行。</span>

![image-20210311235943094](assets/image-20210311235943094.png)
...
![image-20210312000352792](assets/image-20210312000352792.png)
...
![image-20210312001512266](assets/image-20210312001512266.png)
...
![image-20210312002001198](assets/image-20210312002001198.png)
...
![image-20210312002031515](assets/image-20210312002031515.png)



#### 2.2 build/webpack.dev.config.js
...
![image-20210312002152018](assets/image-20210312002152018.png)

![image-20210312002158765](assets/image-20210312002158765.png)

在HtmlWebpackPlugin配置html模板，生成的js就会自动插入到模板中，如下面的配置。

因此生成的js文件会被自动插入到名为index.html的页面中

![image-20210312002209405](assets/image-20210312002209405.png)
...
![image-20210312002223811](assets/image-20210312002223811.png)

![image-20210312002229066](assets/image-20210312002229066.png)
...
![image-20210312002239297](assets/image-20210312002239297.png)

#### 2.5 config/dev.env.js

定义全局常量值

![image-20210312002249970](assets/image-20210312002249970.png)

![image-20210312002253606](assets/image-20210312002253606.png)
...
![image-20210312002307679](assets/image-20210312002307679.png)
...
![image-20210312002317371](assets/image-20210312002317371.png)
...
![image-20210312002339525](assets/image-20210312002339525.png)